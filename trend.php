        ...
        <div class="upper w-100" style="border-radius:5px;">
            ...
            <div class="left">
                ...
                <div> 
                    ...
                    <select id="syear" name="syear" class="selectpicker" data-width="70%" title="연도 선택" aria-label="Default select example">
                        <?php foreach ($year_options as $year_options) { ?>
                        <option><?php echo $year_options['연도']; ?> </option>
                        <?php } ?>
                    </select> 
                    연도 
                    <select id="squarter" name="squarter" class="selectpicker" data-width="70%" title="분기 선택" aria-label="Default select example">
                ...
                <div> 
                    ...
                    <select id="eyear" name="eyear" class="selectpicker" data-width="70%" title="연도 선택" aria-label="Default select example">
                        <?php foreach ($year_options as $year_options) { ?>
                        <option><?php echo $year_options['연도']; ?> </option>
                        <?php } ?>
                    </select> 
                    연도 
                    <select id="equarter" name="equarter" class="selectpicker" data-width="70%" title="분기 선택" aria-label="Default select example">
                        <?php foreach ($quarter_options as $quarter_options) { ?>
                        <option><?php echo $quarter_options['분기']; ?> </option>
                        <?php } ?>
                    </select>
